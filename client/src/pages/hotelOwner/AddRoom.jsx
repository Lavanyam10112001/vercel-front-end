...
const AddRoom = () => {
  ...
  return (
    <form className="text-black bg-#da91b7 min-h-screen p-6">
      {/* Title */}
      <Title
        align="left"
        font="outfit"
      ...
      <p className="mt-10 font-medium">Images</p>
      ...
      <div className="flex flex-col flex-wrap mt-1 max-w-sm text-black">
